...
import ryerson.ca.enroll.endpoint.MyAppServletContextListener;
            ...
            public void onNext(EventReceive value) {
                try {
                    ...
                    if(msgParts.length==4){
                        if(msgParts[0].equals("WAITLIST")){
                        
                          String courseid=msgParts[1];
                          String spots=msgParts[2];
                          String date=msgParts[3];
                          COURSE_Waitlist_CRUD.addWaitlist(courseid, spots, date);
                        }
                    }
